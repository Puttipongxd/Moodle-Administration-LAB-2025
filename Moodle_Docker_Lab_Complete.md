...
**บันทึกผลการทดลอง 2:**
<img width="1105" height="175" alt="image" src="https://github.com/user-attachments/assets/69867a47-cb36-47d7-a161-a09c6d93aa00" />
...
**บันทึกผลการทดลอง 3:**
<img width="1085" height="89" alt="image" src="https://github.com/user-attachments/assets/8f164069-0d6b-4358-92b2-8af501c12728" />
...
```
**บันทึกผลการทดลอง 4:**
<img width="1257" height="999" alt="image" src="https://github.com/user-attachments/assets/87b5fbba-c770-4e52-bb70-ec12318a047c" />
...
**บันทึกผลการทดลอง 5:**
<img width="872" height="427" alt="image" src="https://github.com/user-attachments/assets/b4e6500a-bc38-457d-8f5e-547e86752bf7" />
...
**บันทึกผลการทดลอง 6:**
<img width="471" height="816" alt="image" src="https://github.com/user-attachments/assets/35a1b14e-596f-4da8-ad41-dc899fe4bc1c" />
...
<img width="1915" height="758" alt="image" src="https://github.com/user-attachments/assets/2126df16-181e-4208-91cf-bca05739a99e" />
...
**บันทึกผลการทดลอง 7:**
<img width="1919" height="1078" alt="image" src="https://github.com/user-attachments/assets/d13dd0ef-f4e8-4816-8bd0-09f36b1b0172" />
...
**บันทึกผลการทดลอง 8:**
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/80adfe5a-2c28-4368-8ef8-e2e480c0b0d9" />
...
**บันทึกผลการทดลอง 9:**
<img width="1918" height="1077" alt="image" src="https://github.com/user-attachments/assets/f7b63e02-bf8d-484b-88f8-da227580f759" />
...
**บันทึกผลการทดลอง 10:**
<img width="1919" height="1077" alt="image" src="https://github.com/user-attachments/assets/a90d0ebc-d282-4c29-bc0b-b8187df1a201" />
...
5. 
   **บันทึกผลการทดลอง 11:**
   <img width="1919" height="1079" alt="image" src="https://github.com/user-attachments/assets/8b6126ec-db08-4c75-9007-fb3aaeb0b4b4" />
...
คำตอบ:
```
Docker Image คือ ต้นแบบ (Template) ที่ใช้สร้าง Container ซึ่งประกอบด้วยระบบปฏิบัติการ ไลบรารี และโปรแกรมที่จำเป็น
Docker Container คือ อินสแตนซ์ที่กำลังรันอยู่ของ Image ซึ่งสามารถทำงานจริงไ
```
...
Moodle Container (moodle_app) — ให้บริการเว็บไซต์ Moodle
Database Container (db) — จัดเก็บข้อมูล เช่น ผู้ใช้ รายวิชา คะแนน
```
...
คำตอบ:
```
ใช้ Named Volume เพื่อเก็บข้อมูลถาวร

ข้อดี:
ข้อมูลไม่หายเมื่อ Container ถูกลบ
สำรองและกู้คืนข้อมูลง่าย

ข้อเสีย:
ต้องจัดการพื้นที่เก็บข้อมูลเอง
...
คำตอบ:
```
Network ใช้สำหรับ เชื่อมต่อ Container ให้สามารถสื่อสารกันได้
Container ติดต่อกันผ่าน ชื่อ Service เช่น Moodle ติดต่อ Database ด้วยชื่อ db แทน IP Address
...
เพื่อให้ Database เริ่มทำงานก่อน Moodle ลดปัญหาการเชื่อมต่อผิดพลาด
```
...
คำตอบ:
```
แก้ไขส่วน ports ใน docker-compose.yml
ports:
  - "9000:8080"
...
คำตอบ:
```
หมายถึงให้ Moodle เชื่อมต่อ Database ผ่าน Service Name db
ไม่ใช้ localhost เพราะ:
localhost จะชี้ไปที่ Container ตัวเอง
...
ตรวจสอบชื่อ Database Host
ตรวจสอบว่า Database Container ทำงานอยู่หรือไม่

วิธีแก้ไข:
แก้ค่า MOODLE_DB_HOST ให้ถูกต้อง
Restart Container
docker-compose restart
```
...
คำตอบ:
```
คำสั่งนี้จะ ลบ Container และลบ Volume ทั้งหมด
ทำให้ ข้อมูล Database และไฟล์ถาวรถูกลบถาวร และไม่สามารถกู้คืนได้
